...
class _ForgotPasswordScreenState extends ConsumerState<ForgotPasswordScreen> {
  ...
  Future<void> _requestReset() async {
    ...
    await ref.read(authNotifierProvider.notifier).requestPasswordReset(_phoneCtrl.text.trim());
  ...
  Future<void> _verifyReset() async {
    ...
    setState(() => _isLoading = true);
    final req = PasswordResetVerifyRequest(phone: _phoneCtrl.text.trim(), otp: _otpCtrl.text.trim(), newPassword: _newPwCtrl.text);
  ...
  Widget _s1() => Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
    ...
    TextField(controller: _phoneCtrl, keyboardType: TextInputType.phone, decoration: InputDecoration(hintText: 'Phone Number', prefixIcon: const Icon(Icons.phone_android), filled: true, fillColor: AppColors.white, border: OutlineInputBorder(borderRadius: BorderRadius.circular(8), borderSide: BorderSide.none))),
