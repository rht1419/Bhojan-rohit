...
class RealVendorAuthService implements VendorAuthServiceInterface {
  ...
  Future<void> register(VendorRegisterRequest request) async {
    try {
      await _api.dio.post('/vendor/auth/register', data: request.toJson());
  ...
  Future<void> requestOtp(String phone) async {
    try {
      await _api.dio.post('/vendor/auth/request-otp', data: {'phone': phone});
    } on DioException catch (e) {
      _handleDioError(e);
    }
  }
  ...
  Future<VendorLoginResponse> verifyOtp(VerifyOtpRequest request) async {
    try {
      final response = await _api.dio.post('/vendor/auth/verify-otp', data: request.toJson());
