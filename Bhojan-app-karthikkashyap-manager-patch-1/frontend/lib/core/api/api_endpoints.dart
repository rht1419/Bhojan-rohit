class ApiEndpoints {
  ...
  static const String loginOtpRequest     = '/auth/login/otp-request';  // Request OTP for login
  ...
  // ── Vendor App — Auth ────────────────────────────────────────────
  static const String vendorSelfRegister  = '/vendor/auth/register';    // Self-reg
  static const String vendorRequestOtp   = '/vendor/auth/request-otp'; // Self-reg resend
  static const String vendorVerifyOtp    = '/vendor/auth/verify-otp';  // Self-reg verify
  ...
  static const String delegates           = '/admin/delegations';       // EP-30, EP-31
  static String delegateRevoke(String id)  => '/admin/delegations/$id'; // EP-32
