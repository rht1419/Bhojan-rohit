...
class _GuestRegisterScreenState extends ConsumerState<GuestRegisterScreen> {
  ...
  Future<void> _submit() async {
    // #region agent log H11 guest submit entry
    debugPrint('[DBG-H11] guest_submit tapped agreed=$_agreedToTerms phoneRaw=${_phoneController.text.trim()}');
    // #endregion
    if (!_formKey.currentState!.validate() || !_agreedToTerms) {
      // #region agent log H11 guest submit blocked
      debugPrint('[DBG-H11] guest_submit blocked formValid=${_formKey.currentState!.validate()} agreed=$_agreedToTerms');
      // #endregion
      return;
    }
